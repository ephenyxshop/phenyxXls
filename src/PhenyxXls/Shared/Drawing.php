...
namespace EphenyxShop\PhenyxXls\Shared;

use GdImage;
use EphenyxShop\PhenyxXls\Reader\Exception as ReaderException;
...
class Drawing
{
     ...
     */
    public static function pixelsToCellDimension($pixelValue, \EphenyxShop\PhenyxXls\Style\Font $defaultFont)
    {
        // Font name and size
     ...
     * @param \EphenyxShop\PhenyxXls\Style\Font $defaultFont Default font of the workbook
     *
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($cellWidth, \EphenyxShop\PhenyxXls\Style\Font $defaultFont)
    {
        // Font name and size
        $name = $defaultFont->getName();
        $size = $defaultFont->getSize();
