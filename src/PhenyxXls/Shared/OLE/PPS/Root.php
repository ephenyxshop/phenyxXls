...
namespace EphenyxShop\PhenyxXls\Shared\OLE\PPS;
...
use EphenyxShop\PhenyxXls\Shared\OLE\PPS;
...
class Root extends PPS
{
    ...
    /**
     * Saving big data (PPS's with data bigger than \EphenyxShop\PhenyxXls\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param int $iStBlk
    ...
    /**
     * get small data (PPS's with data smaller than \EphenyxShop\PhenyxXls\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param array $raList Reference to array of PPS's
     *
     * @return string
