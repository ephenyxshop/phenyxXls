...
use EphenyxShop\PhenyxXls\Shared\Escher;
use EphenyxShop\PhenyxXls\Shared\Escher\DgContainer;
use EphenyxShop\PhenyxXls\Shared\Escher\DgContainer\SpgrContainer;
use EphenyxShop\PhenyxXls\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use EphenyxShop\PhenyxXls\Shared\Escher\DggContainer;
use EphenyxShop\PhenyxXls\Shared\Escher\DggContainer\BstoreContainer;
use EphenyxShop\PhenyxXls\Shared\Escher\DggContainer\BstoreContainer\BSE;
use EphenyxShop\PhenyxXls\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;
use EphenyxShop\PhenyxXls\Shared\OLE;
use EphenyxShop\PhenyxXls\Shared\OLE\PPS\File;
use EphenyxShop\PhenyxXls\Shared\OLE\PPS\Root;
use EphenyxShop\PhenyxXls\Spreadsheet;
use EphenyxShop\PhenyxXls\Worksheet\BaseDrawing;
use EphenyxShop\PhenyxXls\Worksheet\Drawing;
use EphenyxShop\PhenyxXls\Worksheet\MemoryDrawing;
use EphenyxShop\PhenyxXls\Writer\Xls\Parser;
use EphenyxShop\PhenyxXls\Writer\Xls\Workbook;
use EphenyxShop\PhenyxXls\Writer\Xls\Worksheet;
    ...
    private function buildWorksheetEschers(): void
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = \EphenyxShop\PhenyxXls\Shared\Xls::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
