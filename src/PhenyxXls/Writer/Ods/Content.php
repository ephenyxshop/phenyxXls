...
use EphenyxShop\PhenyxXls\Worksheet\Row;
use EphenyxShop\PhenyxXls\Worksheet\RowCellIterator;
use EphenyxShop\PhenyxXls\Worksheet\Worksheet;
use EphenyxShop\PhenyxXls\Writer\Exception;
use EphenyxShop\PhenyxXls\Writer\Ods;
use EphenyxShop\PhenyxXls\Writer\Ods\Cell\Comment;
use EphenyxShop\PhenyxXls\Writer\Ods\Cell\Style;
...
//                $objWriter->writeAttribute('table:number-columns-repeated', self::NUMBER_COLS_REPEATED_MAX);
    ...
    private function writeCells(XMLWriter $objWriter, RowCellIterator $cells): void
    {
        ...
        foreach ($cells as $cell) {
            /** @var \EphenyxShop\PhenyxXls\Cell\Cell $cell */
