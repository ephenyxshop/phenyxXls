...
use EphenyxShop\PhenyxXls\Shared\Drawing as SharedDrawing;
use EphenyxShop\PhenyxXls\Shared\File;
use EphenyxShop\PhenyxXls\Shared\Font as SharedFont;
...
class Html extends BaseWriter
{
     ...
     *
     * @param Worksheet $worksheet \EphenyxShop\PhenyxXls\Worksheet\Worksheet
    ...
    private function generateRowWriteCell(string &$html, Worksheet $worksheet, string $coordinate, string $cellType, string $cellData, int $colSpan, int $rowSpan, $cssClass, int $colNum, int $sheetIndex, int $row): void
    {
        ...
        if (!$this->useInlineCss && !$this->isPdf && is_string($cssClass)) {
            ...
            //** Necessary redundant code for the sake of \EphenyxShop\PhenyxXls\Writer\Pdf **
