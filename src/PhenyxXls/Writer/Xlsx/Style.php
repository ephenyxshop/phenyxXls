...
class Style extends WriterPart
{
     ...
     * Write Cell Style Xf.
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \EphenyxShop\PhenyxXls\Style\Style $style, Spreadsheet $spreadsheet): void
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', '0');
     ...
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \EphenyxShop\PhenyxXls\Style\Style $style): void
    {
        // dxf
     ...
     *
     * @return \EphenyxShop\PhenyxXls\Style\Style[] All styles in PhenyxXls
     */
    ...
    public function allFills(Spreadsheet $spreadsheet)
    {
        ...
        /** @var \EphenyxShop\PhenyxXls\Style\Style $style */
