...
class Comments extends WriterPart
{
     ...
     */
    public function writeComments(\EphenyxShop\PhenyxXls\Worksheet\Worksheet $worksheet)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @return string XML Output
     */
    public function writeVMLComments(\EphenyxShop\PhenyxXls\Worksheet\Worksheet $worksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
