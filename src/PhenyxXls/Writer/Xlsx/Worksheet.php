...
use EphenyxShop\PhenyxXls\Style\ConditionalFormatting\ConditionalDataBar;
use EphenyxShop\PhenyxXls\Style\ConditionalFormatting\ConditionalFormattingRuleExtension;
use EphenyxShop\PhenyxXls\Worksheet\SheetView;
use EphenyxShop\PhenyxXls\Worksheet\Worksheet as PhpspreadsheetWorksheet;
...
class Worksheet extends WriterPart
{
    ...
    private function writeDrawings(XMLWriter $objWriter, PhpspreadsheetWorksheet $worksheet, $includeCharts = false): void
    {
        ...
        if (isset($unparsedLoadedData['sheets'][$worksheet->getCodeName()]['drawingOriginalIds'])) {
            ...
            // (! synchronize with \EphenyxShop\PhenyxXls\Writer\Xlsx\Rels::writeWorksheetRelationships)
