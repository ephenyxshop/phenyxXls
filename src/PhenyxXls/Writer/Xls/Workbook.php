...
class Workbook extends BIFFwriter
{
     ...
     * XF Writers.
     *
     * @var \EphenyxShop\PhenyxXls\Writer\Xls\Xf[]
     */
    private $xfWriters = [];
     ...
     */
    public function addFont(\EphenyxShop\PhenyxXls\Style\Font $font)
    {
     ...
     */
    private function writeBoundSheet(\EphenyxShop\PhenyxXls\Worksheet\Worksheet $sheet, $offset): void
    {
        ...
        switch ($sheet->getSheetState()) {
            case \EphenyxShop\PhenyxXls\Worksheet\Worksheet::SHEETSTATE_VISIBLE:
                $ss = 0x00;

                break;
            case \EphenyxShop\PhenyxXls\Worksheet\Worksheet::SHEETSTATE_HIDDEN:
                $ss = 0x01;

                break;
            case \EphenyxShop\PhenyxXls\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN:
                $ss = 0x02;
