...
use GdImage;
use EphenyxShop\PhenyxXls\Cell\Cell;
use EphenyxShop\PhenyxXls\Cell\Coordinate;
use EphenyxShop\PhenyxXls\Cell\DataType;
use EphenyxShop\PhenyxXls\Exception as PhenyxXlsException;
use EphenyxShop\PhenyxXls\RichText\RichText;
use EphenyxShop\PhenyxXls\RichText\Run;
use EphenyxShop\PhenyxXls\Shared\StringHelper;
use EphenyxShop\PhenyxXls\Shared\Xls;
use EphenyxShop\PhenyxXls\Style\Border;
use EphenyxShop\PhenyxXls\Style\Color;
use EphenyxShop\PhenyxXls\Style\Conditional;
use EphenyxShop\PhenyxXls\Style\Protection;
use EphenyxShop\PhenyxXls\Worksheet\PageSetup;
use EphenyxShop\PhenyxXls\Worksheet\SheetView;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \EphenyxShop\PhenyxXls\Writer\Xls\Parser
     */
    private $parser;
     ...
     * Sheet object.
     *
     * @var \EphenyxShop\PhenyxXls\Worksheet\Worksheet
     */
    public $phpSheet;
     ...
     *
     * @var null|\EphenyxShop\PhenyxXls\Shared\Escher
     */
    private $escher;
     ...
     * @param \EphenyxShop\PhenyxXls\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \EphenyxShop\PhenyxXls\Worksheet\Worksheet $phpSheet)
    {
     ...
     *
     * @see \EphenyxShop\PhenyxXls\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close(): void
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \EphenyxShop\PhenyxXls\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParentOrThrow()->getDefaultStyle()->getFont());
        }
     ...
     * Get Escher object.
     */
    public function getEscher(): ?\EphenyxShop\PhenyxXls\Shared\Escher
    {
        return $this->escher;
    }
     ...
     * Set Escher object.
     */
    public function setEscher(?\EphenyxShop\PhenyxXls\Shared\Escher $escher): void
    {
        $this->escher = $escher;
    }
    ...
    private function writeCFRule(
        ...
        if ($bFormatFont == 1) {
            ...
            switch ($conditional->getStyle()->getFont()->getUnderline()) {
                case \EphenyxShop\PhenyxXls\Style\Font::UNDERLINE_NONE:
                    $dataBlockFont .= pack('C', 0x00);
                    $fontUnderline = 0;

                    break;
                case \EphenyxShop\PhenyxXls\Style\Font::UNDERLINE_DOUBLE:
                    $dataBlockFont .= pack('C', 0x02);
                    $fontUnderline = 0;

                    break;
                case \EphenyxShop\PhenyxXls\Style\Font::UNDERLINE_DOUBLEACCOUNTING:
                    $dataBlockFont .= pack('C', 0x22);
                    $fontUnderline = 0;

                    break;
                case \EphenyxShop\PhenyxXls\Style\Font::UNDERLINE_SINGLE:
                    $dataBlockFont .= pack('C', 0x01);
                    $fontUnderline = 0;

                    break;
                case \EphenyxShop\PhenyxXls\Style\Font::UNDERLINE_SINGLEACCOUNTING:
