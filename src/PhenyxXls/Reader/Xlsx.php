...
namespace EphenyxShop\PhenyxXls\Reader;

use EphenyxShop\PhenyxXls\Cell\Coordinate;
use EphenyxShop\PhenyxXls\Cell\DataType;
use EphenyxShop\PhenyxXls\Cell\Hyperlink;
use EphenyxShop\PhenyxXls\DefinedName;
use EphenyxShop\PhenyxXls\Reader\Security\XmlScanner;
use EphenyxShop\PhenyxXls\Reader\Xlsx\AutoFilter;
use EphenyxShop\PhenyxXls\Reader\Xlsx\Chart;
use EphenyxShop\PhenyxXls\Reader\Xlsx\ColumnAndRowAttributes;
use EphenyxShop\PhenyxXls\Reader\Xlsx\ConditionalStyles;
use EphenyxShop\PhenyxXls\Reader\Xlsx\DataValidations;
use EphenyxShop\PhenyxXls\Reader\Xlsx\Hyperlinks;
use EphenyxShop\PhenyxXls\Reader\Xlsx\Namespaces;
use EphenyxShop\PhenyxXls\Reader\Xlsx\PageSetup;
use EphenyxShop\PhenyxXls\Reader\Xlsx\Properties as PropertyReader;
use EphenyxShop\PhenyxXls\Reader\Xlsx\SheetViewOptions;
use EphenyxShop\PhenyxXls\Reader\Xlsx\SheetViews;
use EphenyxShop\PhenyxXls\Reader\Xlsx\Styles;
use EphenyxShop\PhenyxXls\Reader\Xlsx\TableReader;
use EphenyxShop\PhenyxXls\Reader\Xlsx\Theme;
use EphenyxShop\PhenyxXls\Reader\Xlsx\WorkbookView;
use EphenyxShop\PhenyxXls\ReferenceHelper;
use EphenyxShop\PhenyxXls\RichText\RichText;
use EphenyxShop\PhenyxXls\Settings;
use EphenyxShop\PhenyxXls\Shared\Date;
use EphenyxShop\PhenyxXls\Shared\Drawing;
use EphenyxShop\PhenyxXls\Shared\File;
use EphenyxShop\PhenyxXls\Shared\Font;
use EphenyxShop\PhenyxXls\Shared\StringHelper;
use EphenyxShop\PhenyxXls\Spreadsheet;
use EphenyxShop\PhenyxXls\Style\Color;
use EphenyxShop\PhenyxXls\Style\Font as StyleFont;
use EphenyxShop\PhenyxXls\Style\NumberFormat;
use EphenyxShop\PhenyxXls\Style\Style;
use EphenyxShop\PhenyxXls\Worksheet\HeaderFooterDrawing;
...
class Xlsx extends BaseReader
{
                                        ...
                                        if (isset($shape['style'])) {
                                            ...
                                            if (($column !== null) && ($row !== null)) {
                                                ...
                                                if (isset($drowingImages[$fillImageRelId])) {
                                                    $objDrawing = new \EphenyxShop\PhenyxXls\Worksheet\Drawing();
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u)) {
                            ...
                            if (!isset($attr['val'])) {
                                $objFont->setUnderline(\EphenyxShop\PhenyxXls\Style\Font::UNDERLINE_SINGLE);
                            } else {
     ...
     */
    private function readHyperLinkDrawing(\EphenyxShop\PhenyxXls\Worksheet\Drawing $objDrawing, SimpleXMLElement $cellAnchor, $hyperlinks): void
    {
