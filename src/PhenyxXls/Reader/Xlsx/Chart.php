...
namespace EphenyxShop\PhenyxXls\Reader\Xlsx;

use EphenyxShop\PhenyxXls\Calculation\Information\ExcelError;
use EphenyxShop\PhenyxXls\Chart\Axis;
use EphenyxShop\PhenyxXls\Chart\ChartColor;
use EphenyxShop\PhenyxXls\Chart\DataSeries;
use EphenyxShop\PhenyxXls\Chart\DataSeriesValues;
use EphenyxShop\PhenyxXls\Chart\GridLines;
use EphenyxShop\PhenyxXls\Chart\Layout;
use EphenyxShop\PhenyxXls\Chart\Legend;
use EphenyxShop\PhenyxXls\Chart\PlotArea;
use EphenyxShop\PhenyxXls\Chart\Properties as ChartProperties;
use EphenyxShop\PhenyxXls\Chart\Title;
use EphenyxShop\PhenyxXls\Chart\TrendLine;
use EphenyxShop\PhenyxXls\Reader\Xlsx;
...
class Chart
{
     ...
     *
     * @return \EphenyxShop\PhenyxXls\Chart\Chart
     */
    public function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \EphenyxShop\PhenyxXls\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
        if ($chartNoFill) {
