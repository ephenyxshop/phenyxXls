...
namespace EphenyxShop\PhenyxXls\Cell;
...
use EphenyxShop\PhenyxXls\Shared\Date as SharedDate;
use EphenyxShop\PhenyxXls\Shared\StringHelper;
use EphenyxShop\PhenyxXls\Style\ConditionalFormatting\CellStyleAssessor;
use EphenyxShop\PhenyxXls\Style\NumberFormat;
use EphenyxShop\PhenyxXls\Style\Style;
use EphenyxShop\PhenyxXls\Worksheet\Table;
    ...
    public static function setCalculateDateTimeType(int $calculateDateTimeType): void
    {
        switch ($calculateDateTimeType) {
            ...
            case self::CALCULATE_TIME_FLOAT:
                ...
                break;
            default:
                throw new \EphenyxShop\PhenyxXls\Calculation\Exception("Invalid value $calculateDateTimeType for calculated date time type");
        }
    }
    ...
    public function getCalculatedValue(bool $resetLog = true)
    {
        if ($this->dataType === DataType::TYPE_FORMULA) {
            try {
                ...
                throw new \EphenyxShop\PhenyxXls\Calculation\Exception(
