...
use EphenyxShop\PhenyxXls\Calculation\Internal\WildcardMatch;
...
use EphenyxShop\PhenyxXls\Worksheet\AutoFilter\Column\Rule;
    ...
    public function __clone()
    {
        ...
        foreach ($vars as $key => $value) {
            if (is_object($value)) {
                ...
                //    The columns array of \EphenyxShop\PhenyxXls\Worksheet\Worksheet\AutoFilter objects
                $this->{$key} = [];
