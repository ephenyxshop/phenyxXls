...
class BaseDrawing implements IComparable
{
    ...
    public function setWorksheet(?Worksheet $worksheet = null, bool $overrideOld = false): self
    {
        if ($this->worksheet === null) {
            // Add drawing to \EphenyxShop\PhenyxXls\Worksheet\Worksheet
            if ($worksheet !== null) {
            ...
            if ($overrideOld) {
                // Remove drawing from old \EphenyxShop\PhenyxXls\Worksheet\Worksheet
                ...
                // Set new \EphenyxShop\PhenyxXls\Worksheet\Worksheet
